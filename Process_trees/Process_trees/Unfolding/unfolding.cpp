...
//    const int ssize = 700;
    ...
    TF1 *ff1_response = new TF1("ff1_response","TMath::Gaus(x, 20) - 0.02*TMath::Gaus(x, 23)",response_rangle_from,max_time);
    ...
    for (int i = 0; i < ssize; ++i)
    {
        ...
        source[i] = ff1_response->Eval(time - 5) + ff1_response->Eval(time - 20) + noise;
