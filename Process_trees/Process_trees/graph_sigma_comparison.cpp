...
//    gr_cd1->GetYaxis()->SetRangeUser(1E-3,1);
    ...
    TGraph *gr_cd1_3 = new TGraph(sim_data_20[0].size(), &sim_data_20[0][0], &sim_data_20[1][0]);
    ...
    leg->AddEntry("gr_cd1_3","Sim, gauss resp=33ns, t_w 20ns (optimum in sim for 300pe)","lp");
