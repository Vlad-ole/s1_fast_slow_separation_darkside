...
//    TGraph *gr_cd2 = new TGraph(time[0].size(), &iter_rep[0][0], &sigma[0][0]);
//    gr_cd2->SetTitle("");
...
//    TGraph *gr_cd2_2 = new TGraph(time[1].size(), &iter_rep[1][0], &sigma[1][0]);
...
//    TGraph *gr_cd3 = new TGraph(time[0].size(), &iter_rep[0][0], &time[0][0]);
//    gr_cd3->SetTitle("");
...
//    TGraph *gr_cd2_3 = new TGraph(time[1].size(), &iter_rep[1][0], &time[1][0]);
//    gr_cd2_3->SetMarkerStyle(20);
//    gr_cd2_3->SetMarkerSize(1);
//    gr_cd2_3->SetMarkerColor(kRed);
//    gr_cd2_3->Draw("same pl");
