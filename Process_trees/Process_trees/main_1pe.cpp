...
//    const int run_id = 6064;
    ...
    if(advanced_processing)
    {
        ...
        else if()
        {
            ...
            TF1 tf1_baseline_ch1("tf1_baseline_ch1","[0]",0,time_scale*xv_cd1.size());
            tf1_baseline_ch1.SetParameter(0,avr_baseline_ch1);
            tf1_baseline_ch1.Draw("same");

            ostringstream sstream_text_cd1_integral;
            sstream_text_cd1_integral << "integral = " << avr_integral_ch1;
            ostringstream sstream_text_cd1_baseline;
            sstream_text_cd1_baseline << "baseline = " << avr_baseline_ch1;
            ...
            TF1 tf1_baseline_ch2("tf1_baseline_ch2","[0]",0,time_scale*xv_cd1.size());
            tf1_baseline_ch2.SetParameter(0,avr_baseline_ch2);
            tf1_baseline_ch2.Draw("same");

            ostringstream sstream_text_cd2_integral;
            sstream_text_cd2_integral << "integral = " << avr_integral_ch2;
            ostringstream sstream_text_cd2_baseline;
            sstream_text_cd2_baseline << "baseline = " << avr_baseline_ch2;
...
//        Hlist_gr.Write();
        ...
        //        ofstream out_file;
//        out_file.open("/home/darkside/Vlad_Programs/Physical_results/avg_signal_Am.txt");
//        for (int j = 0; j < xv_cd1.size(); ++j)
//        {
//            out_file << 0 << " " << (yv_cd1[j] - avr_baseline_ch1) << " " << (yv_cd2[j] - avr_baseline_ch2) << endl;
//        }
//        out_file.close();
